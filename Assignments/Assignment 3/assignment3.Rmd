...
Yes there are two solutions here but I find it important to show that sometimes the base package just doesn't have what you want.  Again with the strong correlation Ca-RI.
...
```
Most likely we are interested in 'SalePrice' above all else.  We see strong positive correlation to sale price with 'OverallQuality', square footage variables, and garage variables.  We see strong negative correlation with price and the variables dealing with age.