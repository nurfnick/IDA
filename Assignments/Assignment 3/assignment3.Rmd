...
Does not appear to be any duplicates in this dataset.  Now we'll create the correlation matrix.  We should remove the 'Id' and 'Type from the data before we do the correlation.
